...
public class SuggestedRequirementsPhaseDurationAction extends Action implements
		Cloneable {
	private Hashtable<Project, Boolean> projs;
	private Hashtable<Employee, Boolean> emps;
	private int timeToLive;

	public SuggestedRequirementsPhaseDurationAction() {
	...
	public Object clone() {
		SuggestedRequirementsPhaseDurationAction cl = (SuggestedRequirementsPhaseDurationAction) (super
				.clone());
