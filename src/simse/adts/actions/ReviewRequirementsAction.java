...
public class ReviewRequirementsAction extends Action implements Cloneable {
	...
	public ReviewRequirementsAction() {
	...
	public Object clone() {
		ReviewRequirementsAction cl = (ReviewRequirementsAction) (super.clone());
