...
public class SuggestedDesignPhaseDurationAction extends Action implements
		Cloneable {
	private Hashtable<Project, Boolean> projs;
	private Hashtable<Employee, Boolean> emps;
	private int timeToLive;

	public SuggestedDesignPhaseDurationAction() {
	...
	public Object clone() {
		SuggestedDesignPhaseDurationAction cl = (SuggestedDesignPhaseDurationAction) (super
				.clone());
