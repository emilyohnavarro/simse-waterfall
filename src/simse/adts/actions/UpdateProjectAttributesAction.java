...
public class UpdateProjectAttributesAction extends Action implements Cloneable {
	private Hashtable<Project, Boolean> projs;
	private Hashtable<Employee, Boolean> emps;

	public UpdateProjectAttributesAction() {
		projs = new Hashtable<Project, Boolean>();
		emps = new Hashtable<Employee, Boolean>();
	}

	public Object clone() {
		UpdateProjectAttributesAction cl = (UpdateProjectAttributesAction) (super
				.clone());
