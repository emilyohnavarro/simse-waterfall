...
public class SuggestedImplIntegrationPhaseDurationAction extends Action
		implements Cloneable {
	private Hashtable<Project, Boolean> projs;
	private Hashtable<Employee, Boolean> emps;
	private int timeToLive;

	public SuggestedImplIntegrationPhaseDurationAction() {
	...
	public Object clone() {
		SuggestedImplIntegrationPhaseDurationAction cl = (SuggestedImplIntegrationPhaseDurationAction) (super
				.clone());
