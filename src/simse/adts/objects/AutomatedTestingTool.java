...
public class AutomatedTestingTool extends Tool implements Cloneable {
	private String name;
	private double cost;
	...
	public AutomatedTestingTool(String n0, double c1, double p2, double e3,
			boolean p4) {
		setName(n0);
		setCost(c1);
	...
	public Object clone() {
		AutomatedTestingTool cl = (AutomatedTestingTool) (super.clone());
		cl.name = name;
		cl.cost = cost;
